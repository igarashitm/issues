Introduction
============
This is a test application for SWITCHYARD-2812, propagating Web Service Security header through SCA HttpInvoker.
The SCA service binding is added on top of demos/policy-security-wss-username. Following is the original description
for the policy-security-wss-username.
