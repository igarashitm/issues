...
public class OrderServiceBean implements OrderService {
    ...
    @Inject
    @Named("PlainBean")
    private PlainBean _plainBean;

    @Override
    public OrderAck submitOrder(Order order) {
        if (_plainBean == null) {
            throw new RuntimeException("PlainBean is not injected");
        }
        // Create an order ack
    ...
    public void postConstruct() {
        System.out.println("************************************************");
        System.out.println("****** @PostConstruct method is invoked on OrderServiceBean");
        System.out.println("************************************************");
    }
    ...
    public void preDestroy() {
        System.out.println("************************************************");
        System.out.println("****** @PreDestroy method is invoked on OrderServiceBean");
        System.out.println("************************************************");
    }
}
