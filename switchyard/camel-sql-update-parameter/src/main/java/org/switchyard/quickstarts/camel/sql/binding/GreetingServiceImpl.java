...
public class GreetingServiceImpl implements GreetingService {
    ...
    @Inject @Reference("UpdateService")
    private SingleGreetService update;
    ...
    System.out.println("Updated [id: " + greeting.getId() + "] from " + greeting.getSender() + " to " + greeting.getReceiver());
            update.execute(greeting);
