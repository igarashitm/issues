...
import org.switchyard.issues.SWITCHYARD1285.jpa.domain.Greet;
import org.switchyard.issues.SWITCHYARD1285.jpa.domain.Greet2;
...
public class AnotherTransactionServiceBean implements StoreService {
    ...
    private Store2Service _storeDb;
    
    @Override
    public final void store(final Greet greet) {
        Greet2 greet2 = new Greet2();
        greet2.setCreatedAt(Calendar.getInstance());
        greet2.setReceiver(getClass().getName());
        greet2.setSender(greet.getSender());
        _storeDb.store(greet2);
        ...
        try {
            ...
            System.out.println("AnotherTransactionStoreServiceBean: Failed to get transaction status");
            e.printStackTrace();
        }
